...
[we learned earlier]({{ page.root }}{% link _episodes/09-motivation.md %}) to make sure this feedback is useful to learners.
...
9. **Embrace mistakes.** No matter how well prepared you are, you will make mistakes. This is OK! Use these opportunities to do [error framing]({{ page.root }}{% link _episodes/09-motivation.md %}) and to help your learners learn the art of troubleshooting.
